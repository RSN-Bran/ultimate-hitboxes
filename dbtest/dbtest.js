...
con.connect(function(err) {
  ...
  var sql = "CREATE TABLE MoveLogs_production (ID int NOT NULL AUTO_INCREMENT,DateTime DATETIME NOT NULL,IP varchar(255),CharacterNum varchar(255),CharacterName varchar(255), MoveName varchar(255), URL varchar(255),PRIMARY KEY (ID));"
