...
function Character(props) {
	...
	let dark_light = props.dark_light === 0 ? "character-dark" : "character-light"
	let complete = props.character.completed ? "character-complete" : "character-incomplete"
	let characterClassName = `character ${complete} ${dark_light}`
