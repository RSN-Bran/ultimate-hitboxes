  ...
  return (
    ...
    <div id="header">
      <div id="help">
        ...
        <img id="backButton" className="helpButtons" src={back[props.dark_light]} onClick={() => {history.goBack(); history.go(0); console.log(history.location.pathname); console.log(history)}} />
